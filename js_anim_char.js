let quiz_data = {
    "애니메이션": [
        {"캐릭터이미지": "./exImg/애니캐릭터_우즈마키나루토.png", "정답": ["나루토", "우즈마키나루토"], "출연작": "나루토"},
        {"캐릭터이미지": "./exImg/애니캐릭터_몽키D루피.png", "정답": ["루피", "몽키d루피"], "출연작": "원피스"},
        {"캐릭터이미지": "./exImg/애니캐릭터_프랑키.png", "정답": ["프랑키"], "출연작": "원피스"},
        {"캐릭터이미지": "./exImg/애니캐릭터_롤로노아조로.png", "정답": ["조로", "롤로노아조로"], "출연작": "원피스"},
        {"캐릭터이미지": "./exImg/애니캐릭터_나미.png", "정답": ["나미"], "출연작": "원피스"}
    ]
